...
BestInPlaceEditor.prototype = {
  ...
  activate : function() {
	  if (this.formType == "select" && this.load_collection_url !== undefined) {
    	  var editor = this;
		  editor.ajax({
		    "type"       : "get",
		    "url"        : this.load_collection_url,
		    "dataType"   : "json",
		    "success"    : function(data){ editor.values = data;
						editor.activateForm() ;
					},
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.selected_option = self.selected_option || $parent.attr("data-selected_option");
      self.load_collection_url = self.load_collection_url || $parent.attr("data-load_collection_url");
    });
    ...
    self.selected_option = self.element.attr("data-selected_option") || self.selected_option;
    self.load_collection_url = self.element.attr("data-load_collection_url") || self.load_collection_url;
